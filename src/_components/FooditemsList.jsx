...
export default function FooditemsList() {
  ...
  const defaultItems = [
    ...
    { S_No: "2", Resname: "Biryani By Kilo", Name: "Biryani", Price: "349", Image: "/briyani.png", Contact: "9998775265", City: "Delhi", Description: "Aromatic biryani rice with spices and herbs 🍗" },
